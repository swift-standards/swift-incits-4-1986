...
public extension INCITS_4_1986.ControlCharacters {
    /// NULL character (0x00)
...
public extension INCITS_4_1986.ControlCharacters {
    ...
    static let dc1: UInt8 = 0x11

    /// DEVICE CONTROL TWO (0x12)
    static let dc2: UInt8 = 0x12

    /// DEVICE CONTROL THREE (0x13) - XOFF in flow control
    static let dc3: UInt8 = 0x13

    /// DEVICE CONTROL FOUR (0x14)
    static let dc4: UInt8 = 0x14
}

public extension INCITS_4_1986.ControlCharacters {
    /// FILE SEPARATOR (0x1C)
    static let fs: UInt8 = 0x1C
