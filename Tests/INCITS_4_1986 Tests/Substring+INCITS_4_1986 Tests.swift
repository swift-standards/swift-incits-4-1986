...
@Suite
struct `Substring.ASCII - containsCRLF` {
    ...
    func `substrings containing CRLF`(str: String) {
        let sub = str[...]
        #expect(sub.ascii.containsCRLF, "Substring should contain CRLF")
    }
    ...
    func `substrings without CRLF`(str: String) {
        let sub = str[...]
        #expect(!sub.ascii.containsCRLF, "Substring should not contain CRLF")
    }
}
